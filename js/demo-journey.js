/* Template Factory - Del S Plumbing Co live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-dels-miraloma/';
  var LS_CHANGES = 'tf_dels_change_log_v1';
  var LS_PURCHASED = 'tf_dels_purchased_v1';
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Louis at Del S Plumbing Co. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Louis at Del S Plumbing Co. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for Del S Plumbing Co. Hang tight.',
        delay,
        function () {
